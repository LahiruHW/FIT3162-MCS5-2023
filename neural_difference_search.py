...
def evaluate_diff(diff, net_pp, nr=3, n=1000):
  ...
  X,Y = speck.make_speck_train_data(2*n, nr,diff=d);
  # j1 = np.array(Y1);
  # j2 = np.array(Y2);
  # j1_df = pd.DataFrame(Y1)
  # j2_df = pd.DataFrame(Y2)
  ...
  # pd.DataFrame.to_csv(Y2,"C:/Users/Lenovo/Desktop/3162/New folder/y2_value.csv", sep="\t", index=False, encoding='utf-8');
  # pd.DataFrame.to_csv(Z,"C:/Users/Lenovo/Desktop/3162/New folder/z_value.csv", sep="\t", index=False, encoding='utf-8');
  j1 = np.array(Z);
  j2 = np.array(Y2);
  j1_df = pd.DataFrame(j1)
  j2_df = pd.DataFrame(j2)
  j1_df.to_csv("C:/Users/Lenovo/Desktop/3162/New folder/z_value.csv", sep="\t", index=False, encoding='utf-8');
  j2_df.to_csv("C:/Users/Lenovo/Desktop/3162/New folder/y2_value.csv", sep="\t", index=False, encoding='utf-8');
  # pd.DataFrame.to_csv()
  return(val_acc);
  #return (val_acc, Z)
